...
import Vendor from "./scenes/addVendor";
import Geography from "./scenes/geography";
import Product from "./scenes/addProduct";
        ...
        <div className="app">
          ...
          <main className="content">
            ...
            <Routes>
              ...
              <Route path="/team/form" element={<Form />} />
              <Route path="/bar" element={<Bar />} />
              <Route path="/pie" element={<Pie />} />
              <Route path="/line" element={<Line />} />
              <Route path="/faq" element={<FAQ />} />
              <Route path="/geography" element={<Geography />} />
              <Route path="/contacts/vendor" element={<Vendor />} />
              <Route path="/invoices/product" element={<Product />} />
